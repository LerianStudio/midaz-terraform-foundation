...
# resource of its own — everything is created inside _modules/valkey-elasticache, which
# tags from module.naming.tags explicitly. default_tags would duplicate that set
