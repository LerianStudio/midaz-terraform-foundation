################################################################################
# products/br-sfn/msk — the Kafka broker of the br-sfn product
#
...
# state file (aws/products/br-sfn/msk/terraform.tfstate). Its siblings —
...
# module seeded with product = "br-sfn" would produce br-sfn-{env}-vpc and
