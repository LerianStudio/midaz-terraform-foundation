################################################################################
# products/matcher/valkey — the cache datastore of the matcher product
#
...
# state file (aws/products/matcher/valkey/terraform.tfstate). Its siblings —
...
#
#   mode = "dedicated"  -> creates matcher-{env}-valkey, its security group,
...
################################################################################
# Valkey — matcher-{environment}-valkey
# Secret: matcher-{env}-valkey/auth-token   Host: the raw primary endpoint
################################################################################
